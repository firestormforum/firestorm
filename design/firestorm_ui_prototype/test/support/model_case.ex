defmodule FirestormUiPrototype.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import FirestormUiPrototype.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&FirestormUiPrototype.ErrorHelpers.translate_error/1)
